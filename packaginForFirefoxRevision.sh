...
zip -r pageper_source_code.zip src public package* eslint.config.js build.sh vite.config.js index.html README.md packaginForFirefoxRevision.sh BuildFromSource.md LICENSE manifest.json
